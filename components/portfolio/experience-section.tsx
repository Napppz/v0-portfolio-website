...
export function ExperienceSection() {
  const experiences = [
    ...
    },
    {
      id: 2,
      year: "2025",
      title: "Sertifikasi CCNA & IT Bootcamp",
      organization: "Cisco & IT Bootcamp Intensif",
      description: "Sertifikasi profesional CCNA untuk infrastruktur jaringan, serta menyelesaikan program intensif IT Bootcamp untuk mengasah arsitektur komputasi modern.",
      icon: Code2,
    ...
    },
    {
      ...
      organization: "Program Pelatihan Backend",
      description: "Fokus pada pembuatan RESTful API, implementasi Database, dan efisiensi kode menggunakan ekosistem dan bahasa pemrograman Golang dari nol hingga mahir.",
      icon: Award,
