...
export function ExperienceSection() {
  const experiences = [
    ...
    },
    {
      id: 2,
      year: "2024",
      title: "Backend & Golang Bootcamp",
      organization: "IT Bootcamp Intensif",
      description: "Menyelesaikan program pelatihan intensif dalam membangun arsitektur backend modern. Fokus pada pembuatan RESTful API, implementasi Database, dan efisiensi kode menggunakan bahasa Golang.",
      icon: Code2,
    ...
    },
    {
      id: 3,
      year: "2024",
      title: "Sertifikasi CCNA & PCAP",
      organization: "Cisco & Python Institute",
      description: "Meraih sertifikasi profesional CCNA (Introduction to Networks) untuk pemahaman mendalam infrastruktur jaringan, serta sertifikasi PCAP untuk penguasaan bahasa pemrograman Python.",
      icon: Award,
    ...
    },
    {
      id: 4,
      year: "2024",
      title: "Workshop Data & Machine Learning",
      organization: "Seminar & Workshop AI",
      description: "Mengeksplorasi tren teknologi masa depan melalui praktik simulasi Machine Learning, pemrosesan dataset besar, dan implementasi Artificial Intelligence di berbagai industri.",
      icon: Briefcase,
